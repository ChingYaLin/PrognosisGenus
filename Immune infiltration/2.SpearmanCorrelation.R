...
# ----> Write file----
write.csv(df_cor,file="ImmuneCorrelation_SCC_origin(prognosis).csv",row.names = T)
write.csv(df_pvalue,file="ImmuneCorrelation_pvalue_origin(prognosis).csv",row.names = T)
